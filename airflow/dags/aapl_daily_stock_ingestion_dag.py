...
url = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY_ADJUSTED&symbol=AAPL&apikey=W1JGK0HSLX19RW0I&outputsize=full"
...
def get_stock_data(url):
    ...
    with open('aapl_output_daily_stock_adjusted.csv', 'w') as file:
        file.write(df_final)
...
with DAG(
    dag_id="aapl_daily_stock_ingestion_dag",
