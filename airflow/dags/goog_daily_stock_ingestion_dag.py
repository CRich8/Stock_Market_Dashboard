...
url = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY_ADJUSTED&symbol=GOOG&apikey=W1JGK0HSLX19RW0I&outputsize=full"
...
def get_stock_data(url):
    ...
    with open('goog_output_daily_stock_adjusted.csv', 'w') as file:
        file.write(df_final)

OUTPUT_FILE_TEMPLATE = AIRFLOW_HOME + f"/goog_output_daily_stock_adjusted.csv"
CSV_FILE = f"goog_daily_stock_adjusted.csv"
DATASET = "goog_daily_stock"
INPUT_FILETYPE = "csv"
...
with DAG(
    dag_id="goog_daily_stock_ingestion_dag",
