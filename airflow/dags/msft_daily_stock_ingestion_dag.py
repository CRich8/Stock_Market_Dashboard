...
url = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY_ADJUSTED&symbol=MSFT&apikey=W1JGK0HSLX19RW0I&outputsize=full"
...
def get_stock_data(url):
    ...
    with open('msft_output_daily_stock_adjusted.csv', 'w') as file:
        file.write(df_final)
...
with DAG(
    dag_id="msft_daily_stock_ingestion_dag",
